                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-primary-dark/10">
                            ...
                            <TableHead className="font-semibold text-foreground py-4">Rate</TableHead>
                        ...
                        <TableRow>
                            <TableCell colSpan={9} className="text-center py-12">
                                <div className="flex flex-col items-center gap-3">
                                    <div className="text-foreground/60">No gigs found</div>
                                    <button
                            ...
                            {currentJobs.map((job) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="py-4">
                                            <div className="text-sm font-medium text-emerald-600">{job.rate}</div>
                                        </TableCell>
                                        <TableCell className="py-4">
